    ...
    <div className="pt-32 pb-24 bg-brand-cream min-h-screen">
      <div className="container mx-auto px-6 max-w-3xl">
        ...
        <div className="mb-12">
          ...
          <p className="text-brand-gray/60 font-medium">
        ...
        <div className="prose prose-lg prose-slate max-w-none text-brand-gray">
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc pl-6 space-y-2 marker:text-brand-accent">
              ...
              <li>
                Deliver newsletters and marketing communications (with your
                consent)
              </li>
          ...
          <section className="mb-10">
            ...
            <p className="mb-6">
              ...
              information only as necessary to provide services to us and to
          ...
          <section className="mb-10">
            ...
            <p>
              Client financial and business records are retained in accordance
            ...
            <div className="space-y-4">
              <div>
                ...
                <p>
                  ...
                  information. You may contact us to request access to or
              ...
              <div>
                ...
                <p>
                  ...
                  subject to certain exceptions required by law or legitimate
                  business purposes.
                </p>
              </div>
              <div>
                ...
                <p>
                  ...
                  by following the unsubscribe link in our emails, contacting us
                  directly, or updating your communication preferences.
                  Service-related emails may still be sent.
                </p>
              </div>
            </div>
