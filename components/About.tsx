    ...
    <div ref={containerRef}>
      <div ref={statsGridRef} className="grid sm:grid-cols-2 gap-4">
        ...
        <div className="bg-white/5 p-6 rounded-xl border border-white/5 hover:border-white/10 transition-colors">
            ...
            <div className="text-sm text-gray-400 font-medium">Startups Scaled</div>
        </div>
        {/* Stat 2 */}
        <div className="bg-white/5 p-6 rounded-xl border border-white/5 hover:border-white/10 transition-colors">
            <div 
            ...
            <div className="text-sm text-gray-400 font-medium">Capital Raised</div>
        </div>
        {/* Stat 3 */}
        <div className="bg-white/5 p-6 rounded-xl border border-white/5 hover:border-white/10 transition-colors">
            <div 
            ...
            <div className="text-sm text-gray-400 font-medium">M&A Transactions</div>
        </div>
        {/* Stat 4 */}
        <div className="bg-white/5 p-6 rounded-xl border border-white/5 hover:border-white/10 transition-colors">
            <div 
...
const FounderImg = () => {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      if (triggerRef.current && dec1Ref.current && dec2Ref.current && imgRef.current) {
        gsap.timeline({
          scrollTrigger: {
  ...
  return (
    <div ref={containerRef} className="relative flex items-center justify-center py-12 lg:py-0">
        ...
        <div className="relative w-full max-w-md aspect-[4/5] rounded-2xl overflow-hidden shadow-2xl z-10">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 z-20">
              <p className="text-xl md:text-2xl font-serif font-medium italic text-white mb-4 leading-snug drop-shadow-sm">
                "We believe that growth should be deliberate, financially sound, and built to last."
              </p>
              <div className="flex items-center gap-3">
                <div className="h-[2px] w-8 bg-brand-accent"></div>
                <p className="text-brand-accent font-bold tracking-wide text-sm uppercase">Angela Sweeney, Founder</p>
              </div>
            </div>
        </div>

        {/* Decorative background elements behind image - aligned to the constrained image */}
        <div ref={dec1Ref} className="absolute -z-0 top-0 left-0 w-full max-w-md h-full aspect-[4/5] border-2 border-white/5 rounded-2xl hidden md:block"></div>
        <div ref={dec2Ref} className="absolute -z-0 top-0 left-0 w-full max-w-md h-full aspect-[4/5] border-2 border-white/5 rounded-2xl hidden md:block"></div>
      </div>
    </div>
  )
};
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col justify-center">
             <div className="mb-8">
               ...
               <h3 className="text-4xl md:text-5xl font-serif text-white mb-6">Why Founders Trust Us</h3>
             </div>
             ...
             <div className="space-y-6 text-gray-300 text-lg leading-relaxed font-light mb-10 max-w-2xl">
               ...
               <p>
                 Founded by <span className="text-white font-semibold">Angela Sweeney</span>, a visionary CFO and strategic operator, Tealeaf brings over two decades of hands-on experience across 14 startups and 16 M&A transactions.
               </p>
               <p>
                 With more than $100 million raised in capital and a track record spanning SaaS, biotech, fintech, and emerging technologies, Angela builds the financial and operational frameworks that turn ambition into sustainable systems that actually scale.
               </p>
             </div>
