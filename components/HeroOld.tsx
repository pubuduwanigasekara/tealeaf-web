      ...
      <div className="container mx-auto px-6 relative z-10 grid md:grid-cols-2 gap-12 items-center">
        <div className="space-y-8">
          ...
          <h1 className="text-5xl md:text-7xl font-serif text-brand-dark leading-[1.1]">
            Helping founders <br/>
            <span className="text-brand-accent italic">scale with intention.</span>
          </h1>
          <p className="text-lg md:text-xl text-brand-gray leading-relaxed max-w-2xl text-pretty">
            ...
            <span className="relative inline-block px-1 mx-1">
              ...
              <svg className="absolute -bottom-1 left-0 w-full h-2 z-0 text-brand-accent/30" viewBox="0 0 100 10" preserveAspectRatio="none">
        ...
        <div className="relative hidden md:block">
           <div className="relative w-full aspect-[4/5] max-w-md mx-auto">
             ...
             <div className="absolute -right-6 top-1/4 z-30 bg-white p-4 rounded-xl shadow-xl border-l-4 border-brand-accent transform rotate-3 hidden lg:block">
                <div className="text-2xl font-serif font-bold text-brand-primary">20+</div>
                <div className="text-[10px] uppercase tracking-tighter font-bold text-brand-gray">Years of Strategic <br/>Leadership</div>
             </div>
             ...
             <img 
              ...
              onError={(e) => {
                ...
                (e.target as HTMLImageElement).src = "https://images.unsplash.com/photo-1507679799987-c73779587ccf?q=80&w=800&auto=format&fit=crop";
              }}
