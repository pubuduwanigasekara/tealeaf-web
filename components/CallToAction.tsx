...
export const CallToAction: React.FC = () => {
  return (
    <section id="contact" className="py-24 bg-brand-dark text-white relative overflow-hidden lg:min-h-screen grid place-items-center">
       {/* Abstract Background */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
           <h2 className="text-4xl md:text-6xl font-serif mb-6 leading-tight">
             Ready to scale with <span className="text-brand-accent italic">intention?</span>
           </h2>
           <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
            In 30 minutes, we'll identify gaps in your financial foundation and outline exactly what's needed to support your next stage of growth.
           </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center bg-white/5 backdrop-blur-sm rounded-2xl p-8 md:p-12 border border-white/10 max-w-5xl mx-auto">
           <div className="space-y-6">
              <h3 className="text-2xl font-serif mb-6">In this session, we will:</h3>
           ...
           <div className="text-center md:text-left">
              <div className="bg-brand-cream/10 p-8 md:p-10 lg:p-12 rounded-xl text-center space-y-8">
                <h4 className="text-2xl md:text-3xl lg:text-4xl font-serif">Schedule your free discovery call</h4>
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-gray-400">
                    Or email us at <a href="mailto:hello@tealeafconsult.com" className="text-brand-accent hover:text-white transition-colors">hello@tealeafconsult.com</a>
                  </p>
                </div>
              </div>
           </div>
