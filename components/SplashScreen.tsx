...
export const SplashScreen: React.FC<SplashScreenProps> = ({ onComplete }) => {
  ...
  return (
    <div 
      ref={containerRef}
      className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-gradient-to-br from-[#fffdfa] via-[#fff5f0] to-[#fceee9] text-brand-dark overflow-hidden"
    >
      ...
      <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none">
          ...
          <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" className="absolute inset-0 hidden lg:block">
            <circle cx="90%" cy="10%" r="400" className="stroke-brand-primary/10" strokeWidth="2" fill="none" />
            <circle cx="10%" cy="90%" r="300" className="stroke-brand-primary/10" strokeWidth="2" fill="none" />
         </svg>

          <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" className="absolute inset-0 hidden sm:block lg:hidden">
            <circle cx="90%" cy="10%" r="230" className="stroke-brand-primary/10" strokeWidth="2" fill="none" />
            <circle cx="10%" cy="90%" r="200" className="stroke-brand-primary/10" strokeWidth="2" fill="none" />
         </svg>

          <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" className="absolute inset-0 sm:hidden">
            <circle cx="90%" cy="10%" r="160" className="stroke-brand-primary/10" strokeWidth="2" fill="none" />
            <circle cx="10%" cy="90%" r="130" className="stroke-brand-primary/10" strokeWidth="2" fill="none" />
         </svg>
      </div>
      ...
      <div className="relative flex flex-col items-center justify-center p-10 z-10">
        ...
        <div className="overflow-hidden mb-2">
          <h1 
            ref={textRef}
            className="text-4xl md:text-5xl font-serif italic font-medium !leading-[1.5] text-brand-dark"
