...
import { MessageCircleQuestion, TrendingDown, FileSpreadsheet, UserCog, ArrowRight } from 'lucide-react';
  ...
  return (
    <section className="py-24 bg-white relative overflow-hidden">
      ...
      <div ref={containerRef} className="container mx-auto px-6 relative z-10">
        ...
        <div ref={listRef} className="flex flex-col gap-12 max-w-3xl mx-auto mb-20">
          {painPoints.map((point) => (
            <div key={point.id} className="pain-row flex items-center gap-6 md:gap-8 group">
               {/* Icon */}
